...
module.exports = class Email {
  constructor(user, url) {
    ...
    this.url = url;
    this.from = `Al-Adal <${process.env.EMAIL_FROM}>`;
  }
  ...
  async sendWelcome() {
    const html = `
      <h1>Welcome to the Al-Adal Family, ${this.firstName}!</h1>
      <p>We are excited to have you onboard.</p>
      <p>Click <a href="${this.url}">here</a> to get started.</p>
    `;

    await this.send(html, "Welcome to the Al-Adal Family!");
  }
