...
const BradcumbShop = () => {
  ...
  if (segments.includes("category")) {
    apiUrl = `https://server.al-adal.com/api/v1/category/${lastSegment}`;
  } else if (segments.includes("subcategory")) {
    apiUrl = `https://server.al-adal.com/api/v1/subcategory/${lastSegment}`;
  } else if (segments.includes("brand")) {
    apiUrl = `https://server.al-adal.com/api/v1/brand/${lastSegment}`;
  }
