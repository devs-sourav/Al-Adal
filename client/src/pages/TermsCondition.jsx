      ...
      <div className="font-inter mb-20">
        <Containar>
          <div className="max-w-5xl mx-auto p-6">
            <p className="mb-4">
              Welcome to Al-Adal! Before you start shopping, please take a
            ...
            <p className="mb-4">
              By accessing or using the Al-Adal website, you agree to comply
            ...
            <p className="mb-4">
              All content on the Al-Adal website, including text, graphics,
            ...
            <p className="mb-4">
              Al-Adal is not liable for any indirect, incidental, or
            ...
            <p className="mb-4">
              ...
              <a href="mailto:al.adal0021@gmail.com" className="text-blue-500">
